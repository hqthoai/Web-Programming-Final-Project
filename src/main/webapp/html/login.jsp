    ...
    <div id="logreg-forms">
        <form class="form-signin" method="POST" action="../home-login">
            ...
            <div class="social-login">
                <button class="btn facebook-btn social-btn" type="button"><span><i class="fab fa-facebook-f"></i> <a class="forgot-pass js-forgot-pass" href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile%20openid&redirect_uri=http://localhost:8088../LoginGoogleHandler&response_type=code
                ...
                <button class="btn google-btn social-btn" type="button"><span><i class="fab fa-google-plus-g"></i> <a class="forgot-pass js-forgot-pass" href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile%20openid&redirect_uri=http://localhost:8088../LoginGoogleHandler&response_type=code
            ...
            <a href="../forget-password" id="forgot_pswd">Forgot password?</a>
            <hr>
